function [actMap1] = condMap(data,stat,endp,Fs,bg,rect)
%% condMap is the central function for creating conduction velocity maps
% [actMap1] = condMap(data,stat,endp,Fs,bg,rect) calculates the conduction
...
% OUTPUT
% actMap1 = conduction velocity map
