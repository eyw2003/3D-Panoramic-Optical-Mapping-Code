...
Cam=CamC_neutral; % make sure to change the name to CamB, CamC, CamD...
...
silhouetteCamC_neutral=silhouetteCam_neutral; % make sure to change the name to CamB, CamC, CamD...
...
Actmap(Actmap==1)=50;
Actmap(Actmap==2)=100;
save('IMG0227-012DActivationMap.mat','Actmap'); % make sure to change the name with the correct number and correct CamB, CamC, CamD...
...
Actmap=silhouetteCamA_acidic; % make sure to change the name to CamB, CamC, CamD...
Actmap(Actmap==1)=50;
Actmap(Actmap==2)=100;
save('IMG0227-013AActivationMap.mat','Actmap'); % make sure to change the name with the correct number and correct CamB, CamC, CamD...
