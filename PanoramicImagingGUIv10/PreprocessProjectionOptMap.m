function OptMap = PreprocessProjectionOptMap(OptCamAFileName,Pathname,Threshold,TSquare,SSquare,RSquare,QSquare,AxX,AxY,AxZ)
h = waitbar(0,strcat('Calculating the 3-D optical map'));
