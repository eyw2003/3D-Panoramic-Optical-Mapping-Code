function OptMapFinal2 = PreprocessProjectionOptMapPhaseMovie(OptCamAFileName,Pathname,FrameFirst,FrameLast,Threshold,TSquare,SSquare,RSquare,QSquare,AxX,AxY,AxZ)
OptMapFinal2 = zeros(length(AxX),length(AxY),length(AxZ),FrameLast-FrameFirst);
...
clear A A1 A2 J G cmosData1 bg1 Data1 Data2 Data3 Data4
...
for iFrame = FrameFirst:FrameLast
    OptMap = zeros(length(AxX),length(AxY),length(AxZ));
    ...
    if iFrame == FrameFirst
        ...
        OptMapTrans1 = zeros(size(OptMap));
        ...
        OptMapIndexFinal = zeros(size(OptMap));
        for ii=1:length(indMap)
    ...
    clear ii jj kk CoordMapRot OptMapRot1 CoordMapTrans OptMapTrans1
    ...
    for iPt = 1:size(CoordMap,1)
        ...
        if CoordMapFinal(iPt,1) <= LimLR(CoordMapFinal(iPt,2),iz) && CoordMapFinal(iPt,2) <= LimTB(CoordMapFinal(iPt,1),iz)
            if uB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(B3,1) || vB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(B3,2) || uB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0 || vB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0
                OptMap(CoordMapFinal(iPt,1),CoordMapFinal(iPt,2),CoordMapFinal(iPt,3)) = 0;
            else
                OptMap(CoordMapFinal(iPt,1),CoordMapFinal(iPt,2),CoordMapFinal(iPt,3)) = OptMapCamB(vB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)),uB(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)));
            end
        elseif CoordMapFinal(iPt,1) >= LimLR(CoordMapFinal(iPt,2),iz) && CoordMapFinal(iPt,2) <= LimTB(CoordMapFinal(iPt,1),iz)
            if uA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(A3,1) || vA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(A3,2) || uA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0 || vA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0
                ...
                OptMap(CoordMapFinal(iPt,1),CoordMapFinal(iPt,2),CoordMapFinal(iPt,3)) = OptMapCamA(vA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)),uA(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)));
            end
        elseif CoordMapFinal(iPt,1) <= LimLR(CoordMapFinal(iPt,2),iz) && CoordMapFinal(iPt,2) >=  LimTB(CoordMapFinal(iPt,1),iz)
            if uC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(C3,1) || vC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(C3,2) || uC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0 || vC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0
                ...
                OptMap(CoordMapFinal(iPt,1),CoordMapFinal(iPt,2),CoordMapFinal(iPt,3)) = OptMapCamC(vC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)),uC(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)));
            end
        elseif CoordMapFinal(iPt,1) >= LimLR(CoordMapFinal(iPt,2),iz) &&  CoordMapFinal(iPt,2) >= LimTB(CoordMapFinal(iPt,1),iz)
            if uD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(D3,1) || vD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) > size(D3,2) || uD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0 || vD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)) <= 0
                ...
                OptMap(CoordMapFinal(iPt,1),CoordMapFinal(iPt,2),CoordMapFinal(iPt,3)) = OptMapCamD(vD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)),uD(CoordMap(iPt,1),CoordMap(iPt,2),CoordMap(iPt,3)));
            end
        end        
    end
    waitbar((iFrame-FrameFirst+1)/(FrameLast-FrameFirst),h,strcat('Calculating the 3-D optical map: Frame ',num2str(iFrame)));
    OptMapFinal2(:,:,:,iFrame-FrameFirst+1) = OptMap;    
end
close(h)